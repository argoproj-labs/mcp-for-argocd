...
- `list_applicationsets`: List and filter all ApplicationSets
- `get_applicationset`: Get detailed information about a specific ApplicationSet
- `get_applicationset_resource_tree`: Get the resource tree for a specific ApplicationSet
- `generate_applicationset`: Preview the Applications that would be generated by an ApplicationSet spec (dry-run, nothing is created)
- `preview_applicationset`: Fetch an existing ApplicationSet and preview the Applications it would generate
- `create_applicationset`: Create a new ApplicationSet
- `update_applicationset`: Update an existing ApplicationSet
- `delete_applicationset`: Delete an ApplicationSet
